...
from utils_sequence_labelling_bonus_rank import (read_label_examples, convert_examples_to_features)
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    all_keyphrase_matrix = torch.tensor([f.keyphrase_matrix for f in features], dtype=torch.long)
    dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_seq, all_pos_tag_seq, all_weights_seq, all_keyphrase_matrix)
