...
from pytorch_transformers import (WEIGHTS_NAME, BertConfig,
                                  BertForParaTokenClassification, BertTokenizer, BertForKeywordGeneration,
...
MODEL_CLASSES = {
    'bert': (BertConfig, BertForKeywordGeneration, BertTokenizer),
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    dataset = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_seq, all_pos_tag_seq)
